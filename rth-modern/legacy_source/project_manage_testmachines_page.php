...
# Manage Project Page
#
# $RCSfile: project_manage_testmachines_page.php,v $ $Revision: 1.3 $
# ------------------------------------
...
if( !empty( $project_details ) ) {
	...
	if( $rows_machines ) {
		...
		html_no_records_found_message( lang_get('no_testmachines') );
	}
}
...
# ------------------------------------
# $Log: project_manage_testmachines_page.php,v $
