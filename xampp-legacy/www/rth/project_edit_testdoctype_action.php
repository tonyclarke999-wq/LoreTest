...
#
# $RCSfile: project_edit_testdoctype_action.php,v $  $Revision: 1.1.1.1 $
# ------------------------------------
...
project_edit_test_doc_type(	$_POST['project_id'],
							$_POST['test_doc_type_id'],
							session_validate_form_get_field('test_doc_type_required') );

session_validate_form_reset();


html_print_operation_successful( "edit_test_doc_type_page", $redirect_page );

# ------------------------------------
# $Log: project_edit_testdoctype_action.php,v $
