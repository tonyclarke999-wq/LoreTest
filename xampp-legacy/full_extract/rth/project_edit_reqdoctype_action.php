...
#
# $RCSfile: project_edit_reqdoctype_action.php,v $  $Revision: 1.1.1.1 $
# ------------------------------------
...
project_edit_req_doc_type(	$_POST['project_id'],
							$_POST['req_doc_type_id'],
							session_validate_form_get_field('req_doc_type_required') );

session_validate_form_reset();


html_print_operation_successful( "edit_req_doc_type_page", $redirect_page );

# ------------------------------------
# $Log: project_edit_reqdoctype_action.php,v $
