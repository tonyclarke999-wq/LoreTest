...
// Ver:		$Id: jpgraph.php,v 1.1.1.1 2005/11/30 23:01:50 gth2 Exp $
//
...
// PUBLIC METHODS	
	...
	if( empty($_GET[_CSIM_DISPLAY]) ) {
		...
		$htmlwrap = $this->GetHTMLImageMap($aCSIMName)."\n".
		    '<img src="'.CSIMCACHE_HTTP_DIR.$baseimg.'" ISMAP USEMAP="#'.$aCSIMName.'" border='.$aBorder.' width='.$this->img->width.' height='.$this->img->height.">\n";
		...
		echo "<img src='".$aScriptName.$urlarg."' ISMAP USEMAP='#".$aCSIMName.'\' border='.$aBorder.'  width='.$this->img->width.' height='.$this->img->height.">\n";
	    }
	}
	else {
	    $this->Stroke();
